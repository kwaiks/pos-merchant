...
export default function CardLineChart() {
  React.useEffect(() => {
    ...
    const doc: HTMLCanvasElement = document.getElementById("line-chart") as HTMLCanvasElement;
    if (doc){
      const ctx: CanvasRenderingContext2D = doc.getContext("2d") as CanvasRenderingContext2D;
